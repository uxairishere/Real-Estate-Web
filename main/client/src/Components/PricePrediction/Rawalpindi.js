...
import $ from 'jquery';
import jsonDataa from '../assets/rawalpindi_data.json'
...
const Rawalpindi = () => {
    ...
    async function HandleOnSubmit(e) {
        ...
        const response = await axios.post("http://localhost:8000/rawalpindi", formData);
    ...
    // function HandleFuturePredict(year){
    //     console.log(PredictFuture(predictionVal,year))
    // }
    ...
    return (
        <div className='pre-container'>
            ...
            <div className='pre-rawalpindi-cover'></div>
