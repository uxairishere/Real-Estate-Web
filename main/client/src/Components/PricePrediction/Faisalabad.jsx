...
import jsonDataa from '../assets/faisalabad-data.json'
...
const Faisalabad = () => {
    ...
    async function HandleOnSubmit(e) {
        ...
        const response = await axios.post("http://localhost:8000/faisalabad", formData);
    ...
    return (
        <div className='pre-container'>
            ...
            <div className='pre-faisalabad-cover'></div>
